/*
b deve receber a ordenado de forma crescente ou
“ordem não-decrescente”, já que poderá
haver números repetidos. Este é um problema de solução
mais complicada, para a qual haverá
soluções clássicas, que veremos nesta disciplina.
...
public class Q33 {
    public static void main ( String args [] ) {
        ...
        // Aplicando Bubble Sort diretamente no vetor 'b'
        for (i = 0; i < n - 1; i++) {
            boolean parar = true;
            for (j = 0; j < n-1-i; j++) {
                if (b[j] > b[j + 1]) {
